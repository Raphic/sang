			...
			<div class="col-xs-12 col-sm-9 col-md-10">
				...
				<div class="form-group text-right">
					<div class="form-inline">
						<input type="text" class="form-control" placeholder="Search your project">
						<button class="btn btn-default"><i class="fa fa-search"></i></button>
					</div>
				</div>
				<div class="row">
					<div class="profile-ideabook-owner clearfix">
						<div class="col-xs-6 col-sm-4">
							<div class="box-ratio box-1-1 new-profile-ideabook profile-ideabook">
							...
							</div><!-- new-profile-ideabook -->
						</div>

						<?php for ($i=0; $i < 4; $i++) { ?>

						<div class="col-xs-6 col-sm-4">
							<div class="box-ratio box-1-1 profile-ideabook">
								<div class="box-content">
									<a href="#" class="profile-ideabook-image" style="background-image: url(resources/imageDemo.png);"></a>
									<div class="profile-ideabook-info">
										<span>test</span><br>
										<span>5 photos</span>
									</div>
								</div>
							</div><!-- profile-ideabook -->
						</div>

						<?php } ?>

					</div><!-- profile-ideabook-owner -->
				</div>

				<hr> 

				<div class="account-title">
					<h3>Recomment photos</h3>
				</div><!-- account-title -->

				<div class="profile-ideabook-owner-gallery"><!--
					<?php for ($i=0; $i < 10; $i++) { ?>
					--><a href="#" class="profile-ideabook-gallery-image">
						<img src="resources/imageDemo.png" class="img-responsive">
					</a><!--
					<?php } ?>
				--></div>
