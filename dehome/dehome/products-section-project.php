	...
	<div class="products clearfix <?php echo $isListByDefault ? "list" : "grid" ?>">
		...
		<div class="product clearfix">
			<div class="product-image product-image-owner">
		        ...
		        <a href="http://vnexpress.net" style="height:100%; width:100%; display:block">
			...
			<div class="product-content">
				...
				<div class="product-content-owner">
					<span class="worked">
						Việc đã làm: Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium
					</span>
