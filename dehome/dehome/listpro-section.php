		...
		<div class="product clearfix">
			...
			<div class="product-content-pro">
				...
				<div class="product-content-owner">
					...
					<span class="ownercontact">Liên hệ</span>
					
				</div><!-- product-content-owner -->
				<div class="product-name list">
					<h3><a href="#">Tên của dự án</a></h3>
					<span class="list">
						<span>Có 78 người thíchaaa</span>
						<span> | </span>
				...
				<div class="morepro list">
					<a href="#">(8) Dự án</a>
					<a href="#"><img width="16" height="16"  src="https://cdn0.iconfinder.com/data/icons/small-n-flat/24/678134-sign-check-16.png" id="detail-icon-img"> Xác thực</a>
