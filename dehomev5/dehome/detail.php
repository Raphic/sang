		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-8">
				<div class="product-detail-slider clearfix">
					<div id="product-detail-slider" class="carousel slide" data-ride="carousel">
				...
				<div class="product-detail-excerpt">
					...
					</div><!-- product-detail-read-more -->
				</div><!-- product-detail-excerpt -->
				<div class="product-detail-socials">
					<a href="#"><i class="fa fa-facebook"></i></a>
					<a href="#"><i class="fa fa-yahoo"></i></a>
					<a href="#"><i class="fa fa-linkedin"></i></a>
					<a href="#"><i class="fa fa-skype"></i></a>
				</div><!-- product-detail-socials -->
			</div>

			<div class="col-xs-12 visible-xs"><div class="clearfix"><br><br></div></div>
			...
			<div class="col-xs-12 col-sm-5 col-md-4">
				<div class="product-detail-content">
								...
								<div class="modal-content">
									...
									<div class="modal-body">
			                  			<div class="form-group">
			                  				...
			                  				<div class="text-right">Characters left <span>70</span></div>
			                  			</div>
			                  			<div class="form-group">
					...
					<div class="product-detail-user answer">
						...
						<span class="login-to-comment">
							<a href="#"><img src="resources/userIcon.png">Đăng nhập để bình luận</a>
						</span>
						<?php } else { ?>
				...
				<div class="other-products">
					...
					<div class="col-xs-6 col-sm-3 other-product-col">
						<a href="#" class="thumbnail"><img src="resources/imageDemo.png" class="img-responsive"></a>
					</div>
